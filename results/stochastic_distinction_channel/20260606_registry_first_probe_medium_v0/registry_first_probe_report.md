...
- panel: `medium`
- registered vs existence gaps: 11
- registered vs optimized gaps: 17
...
- `a_flip_noise_9_1_channel` / `reg_bad_declared_D_A_E_A`: registered=0, existence=0, optimized=0 -> `not_recovered`
- `a_flip_noise_9_1_channel` / `reg_empty_D_joint_E_joint`: registered=0, existence=0, optimized=0 -> `not_recovered`
...
- `b_flip_noise_3_1_channel` / `reg_bad_declared_D_A_E_A`: registered=0, existence=1, optimized=1 -> `existence_capacity_only`
- `b_flip_noise_3_1_channel` / `reg_empty_D_joint_E_joint`: registered=0, existence=0, optimized=0 -> `not_recovered`
...
- `b_preserved_a_erased_channel` / `reg_bad_declared_D_A_E_A`: registered=0, existence=0, optimized=0 -> `not_recovered`
- `b_preserved_a_erased_channel` / `reg_empty_D_joint_E_joint`: registered=0, existence=0, optimized=0 -> `not_recovered`
