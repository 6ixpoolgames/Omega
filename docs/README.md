...
The current bottom-up restructuring is recorded in the
[Alpha-Omega Fundamental Theory Ledger v0](research_notes/omega_v2/alpha_omega_fundamental_theory_ledger_v0.md).
Its first clean support-level implementation is the
[Projected-Sector Floor Protocol v0](research_notes/omega_v2/projected_sector_floor_protocol_v0.md)
and
[Projected-Sector Floor Report v0](research_notes/omega_v2/projected_sector_floor_report_v0.md).
This layer derives projection-relative order and separate sector diagnostics
without importing controllers, persistence, identity, valuerhood, or value.

The first clean migration-template package is retained separately. Read the
...
Its `omega_v2` and `OmegaV2` namespaces do not import the historical Omega
implementation.

The clean realization layer now distinguishes witness-retaining May
realization from one-policy/all-environments Robust realization. Read the
[May and Robust Realization Protocol v0](research_notes/omega_v2/robust_omega_protocol_v0.md)
and
[May and Robust Realization Report v0](research_notes/omega_v2/robust_omega_report_v0.md).

The first clean audit of where candidate process boundaries come from is also
retained. Read the
[Process Interface Identifiability Protocol v0](research_notes/omega_v2/process_interface_identifiability_protocol_v0.md)
and
[Process Interface Identifiability Report v0](research_notes/omega_v2/process_interface_identifiability_report_v0.md).
Its factorization-transport follow-on is the
[Process Interface Transport Protocol v0](research_notes/omega_v2/process_interface_transport_protocol_v0.md)
and
...
Its generated-controller upgrade is the
[Generated-Controller Robust Separation Protocol v0](research_notes/omega_v2/generated_controller_robust_separation_protocol_v0.md)
and
...
3. [Alpha-Omega Fundamental Theory Ledger v0](research_notes/omega_v2/alpha_omega_fundamental_theory_ledger_v0.md)
4. [Projected-Sector Floor Report v0](research_notes/omega_v2/projected_sector_floor_report_v0.md)
5. [Alpha-Omega Foundation Report v0](research_notes/omega_v2/alpha_omega_foundation_report_v0.md)
6. [Finite Controlled Markov Abstraction Report v0](research_notes/omega_v2/finite_controlled_markov_abstraction_report_v0.md)
7. [May and Robust Realization Report v0](research_notes/omega_v2/robust_omega_report_v0.md)
8. [Process Interface Identifiability Report v0](research_notes/omega_v2/process_interface_identifiability_report_v0.md)
9. [Process Interface Transport Report v0](research_notes/omega_v2/process_interface_transport_report_v0.md)
10. [Robust Joint Separation Report v0](research_notes/omega_v2/robust_joint_separation_report_v0.md)
11. [Generated-Controller Robust Separation Report v0](research_notes/omega_v2/generated_controller_robust_separation_report_v0.md)
12. [Project Overview](PROJECT_OVERVIEW.md)
13. [Active Surface Area](research_notes/omega_theory/active_surface_area_v0.md)
14. [Claims Ledger](CLAIMS_LEDGER.md)
15. [Omega Decision Stack Checkpoint](research_notes/omega_theory/omega_decision_stack_checkpoint_v0.md)
16. [Adaptive Fixed-World Corridor B2.1](research_notes/omega_theory/adaptive_fixed_world_corridor_b21.md)
17. [Adaptive Observation Informativeness v0](research_notes/omega_theory/adaptive_observation_informativeness_v0.md)
18. [Recovery Frame / Irreversibility Weld v0](research_notes/omega_theory/recovery_frame_irreversibility_weld_v0.md)
19. [Recovery-Aware Corridor v0](research_notes/omega_theory/recovery_aware_corridor_v0.md)
20. [Phantom Recoverability Gate v0](research_notes/omega_theory/phantom_recoverability_gate_v0.md)
21. [Recovery Reflection and Nonrecoverable-Loss Dominance v0](research_notes/omega_theory/recovery_reflection_and_loss_dominance_v0.md)
22. [Colonization Axis Report v0](research_notes/omega_theory/colonization_axis_report_v0.md)
23. [Future-Field Reorientation and Declaration Culling v0](research_notes/omega_theory/future_field_reorientation_and_declaration_culling_v0.md)
24. [Substrate Classes and Large Deformers v0](research_notes/omega_theory/substrate_classes_and_large_deformers_v0.md)
25. [Does The Loop Close Soundly?](public/does_the_loop_close_soundly_v0.md)
26. [Omega Closeout v0](research_notes/omega_theory/omega_closeout_v0.md)
27. [Effective Layers](research_notes/omega_theory/effective_layers_realization_forgetting_emergence_v0.md)
...
B2:
  robust continuation corridors as classical viability/safety-game fixed points.
...
Ensemble span:
  ...
  after matching marginal scalar summaries, with a larger three-axis robustness
  case. This is orientation coverage, not population value or relational
  surplus.
...
Joint-tier reduction audit:
  calibration pass before NOLP. Planted reducible coordinates reduce;
  relational composability survives cheap graph-scalar reductions;
  colonization keeps the lens-invariance debt open; joint recovery
...
Substrate / deformer taxonomy:
  ...
  futurism; substrate class changes preservation adapters rather than moral
  class; large deformers include organisms, civilizations, technologies,
  platforms, and memetic systems without implying agency or standing.
```

Use these notes for the current stack:

1. [Omega Decision Floor v0](research_notes/omega_theory/omega_decision_floor_v0.md)
2. [Robust Continuation Corridor v0](research_notes/omega_theory/robust_continuation_corridor_v0.md)
3. [B2 Viability / Safety-Game Docking v0](research_notes/omega_theory/b2_viability_safety_game_docking_v0.md)
4. [Ambiguity-Family RVK Reduction v0](research_notes/omega_theory/ambiguity_family_rvk_reduction_v0.md)
5. [Stationary Containment v0](research_notes/omega_theory/stationary_containment_v0.md)
6. [History-Policy Memorylessness v0](research_notes/omega_theory/history_policy_memorylessness_v0.md)
...
14. [Recovery Reflection and Nonrecoverable-Loss Dominance v0](research_notes/omega_theory/recovery_reflection_and_loss_dominance_v0.md)
15. [Omega Decision Dominance v0](research_notes/omega_theory/omega_decision_dominance_v0.md)
...
B2.1 is the current theory seam. It says that fixed-world ambiguity is not the same as switching ambiguity:

```text
some ambiguity contracts the corridor;
some ambiguity can be safely learned;
some attempted learning is unsafe;
...
The reflection/dominance checkpoint adds the positive condition and the
comparative surface: reflecting recovery frames preserve licenses, local and
joint nonrecoverable losses are not interchangeable, and declared loss profiles
compare only through the registered fact order.

## Retained But Not Front Door

These surfaces remain useful, but should not be treated as the current project center:

- [Future Field Atlas Glossary](FUTURE_FIELD_ATLAS_GLOSSARY.md)
- [Public Results Index](PUBLIC_RESULTS_INDEX.md)
- [Baseline Witness Suite v0](BASELINE_WITNESS_SUITE_V0.md)
- [Omega Formalism Primer](OMEGA_FORMALISM_PRIMER.md)
- [External Reader Guide](EXTERNAL_READER_GUIDE.md)

Future Field Atlas, RFS-MB0, VAL0/VAL1, and older agency-diamond outputs are retained for provenance and instrument design. They do not validate Omega, agency, identity, value, valuerhood, or moral standing.
...
2. [Reproducibility Smoke](REPRODUCIBILITY_SMOKE.md)
3. [Adversarial Review Guide](ADVERSARIAL_REVIEW_GUIDE.md)
4. [How To Add A Witness](HOW_TO_ADD_A_WITNESS.md)

For Lean decision-stack checks, the standard local command is:
...
For the full dense note list, use:

- [Omega Theory Notes Index](research_notes/omega_theory/README.md)
