...
Status: retained
Verdict: asymmetry_not_necessary_or_sufficient_for_declared_features
...
- necessity: rejected_for_declared_operational_features
- independent_enabling: rejected_in_matched_product_control
- coupled_enabling: unresolved
