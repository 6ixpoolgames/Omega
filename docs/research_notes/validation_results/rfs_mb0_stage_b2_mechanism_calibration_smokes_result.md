...
```text
docs/RFS_MB0_STAGE_B2_MECHANISM_CALIBRATION_AND_GAUGE_VIEW_OVERLAY_SPEC.md
docs/RFS_MB0_STAGE_B2_MECHANISM_CALIBRATION_AND_GAUGE_VIEW_OVERLAY_ADDENDUM.md
```
