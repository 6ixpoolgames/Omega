...
| Admissibility as fact/presentation closure. | Soundness and hidden-loss checks | Boundary-invariant facts | ACTIVE TARGET | Generic Galois closure is landed in `PresentationFactClosure.lean`; still need finite recovery/viability instantiation and adversarial collapse tests. | Nonconstant recovery/viability facts survive all intrinsically admissible presentations in a toy substrate. | Honest admissibility families collapse all facts to constants. | Does not prove a valuer, agency, or Omega object. |
