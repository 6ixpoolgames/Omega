...
ProtoOmega:
  derived transport, recoverability, and separation machinery
...
This layer is downstream of Alpha because preorder-indexed transport and
normal-lax recovery already add structure beyond the primitive floor.
...
The next formal target should be a ProtoOmega recoverable-continuity pass, not a
broad OmegaProper expansion. The useful work is to split overloaded recovery
language into more precise derived notions while keeping Alpha clean.
