...
Builds on: `docs/research_notes/validation_results/rfs_mb0/rfs_mb0_substrate_untethering_transition_energy_sweep_result.md` and `docs/specs/archive/rfs_mb0/RFS_MB0_SUBSTRATE_UNTETHERING_TRANSITION_ENERGY_SWEEP_SPEC.md`
