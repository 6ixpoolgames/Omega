...
docs/specs/archive/rfs_mb0/RFS_MB0_FRONTIER_TRANSFORM_SYNDROME_AUDIT_ADDENDUM.md
...
```text
docs/research_notes/validation_results/rfs_mb0/rfs_mb0_frontier_transform_regenerated_phase_b_stage_a_result.md
```
