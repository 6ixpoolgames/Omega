...
baseline-controlled witness batch. It reruns the seven retained finite witnesses,
...
focused pytest suite for all seven witnesses passes
```
...
```text
the seven finite baseline witnesses reproduced;
