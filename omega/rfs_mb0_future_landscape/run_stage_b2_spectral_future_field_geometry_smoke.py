...
def common_condition_fields(
    ...
    keys = (
        ...
        "sampler_temperature",
        "rank_bucket_multiplier",
        "top_m_mechanism_family",
    ...
    if baseline_metadata:
        metadata_keys = (
            ...
            "equivalent_beta_target",
            "apply_reversibility_requested",
            "reversibility_fraction_applied",
            "sampler_postprocess_policy",
            "sampler_family",
            "sampler_temperature",
            "softmax_temperature",
            "rank_bucket_multiplier",
            "rank_condition_window_mean",
            "rank_conditioned_sampler_scope",
            "base_out_degree_target",
            "top_m_base_out_degree",
            "top_m_mechanism_family",
            "top_m_mechanism_rule",
            "top_m_mechanism_core_size",
            "top_m_mechanism_fringe_pool_size",
            "top_m_mechanism_boundary_window",
            "effective_out_degree_target",
            "top_m_calibration_edge_count",
            "edge_jaccard_vs_top_m_calibration",
            "selected_edge_overlap_fraction_vs_top_m_calibration",
            "selected_edge_retention_fraction_vs_top_m_calibration",
            "selected_edge_symmetric_difference_fraction_vs_top_m",
            "selected_rank_mean",
            "calibration_rank_mean",
            "rank_distribution_match_error",
            "rank_bucket_distribution",
            "calibration_rank_bucket_distribution",
            "selected_energy_mean",
            "calibration_energy_mean",
            "energy_mean_delta_vs_top_m",
            "energy_distribution_match_error",
            "energy_bucket_distribution",
            "calibration_energy_bucket_distribution",
            "per_state_rank_bucket_match_error_mean",
            "per_state_rank_bucket_match_error_max",
            "max_entropy_family",
