...
PARENT_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_HORIZON_TRANSPORT_SPECTRAL_RESPONSE_REPAIR_SPEC.md"
MATCHED_NULL_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_HORIZON_TRANSPORT_MATCHED_NULL_AND_FIXTURE_SMOKE_SPEC.md"
EXPANSION_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_HORIZON_TRANSPORT_EXPANSION_SMOKE_SPEC.md"
H128_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_HORIZON_TRANSPORT_RESPONSE_SURFACE_H128_SCALEUP_SPEC.md"
VISCOSITY_SWEEP_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_HORIZON_TRANSPORT_VISCOSITY_HORIZON_BREADTH_SWEEP_SPEC.md"
SUBSTRATE_UNTETHERING_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_SUBSTRATE_UNTETHERING_TRANSITION_ENERGY_SWEEP_SPEC.md"
TRANSITION_ENERGY_CHARACTERIZATION_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_TRANSITION_ENERGY_SUBSTRATE_CHARACTERIZATION_RUN_SPEC.md"
ASYMMETRY_LADDER_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_ASYMMETRY_LADDER_TRANSITION_ENERGY_SUBSTRATE_SPEC.md"
MAX_ENTROPY_PREFLIGHT_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_MAX_ENTROPY_LOCAL_TRANSITION_PREFLIGHT_SPEC.md"
TOP_M_GEOMETRY_AUDIT_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_TOP_M_GEOMETRY_AUDIT_SPEC.md"
TOP_M_MECHANISM_AUDIT_SPEC_ID = "docs/specs/archive/rfs_mb0/RFS_MB0_TOP_M_MECHANISM_AUDIT_SPEC.md"
...
TOP_M_MECHANISM_AUDIT = "top_m_mechanism_audit"
SWEEP_KINDS = frozenset({"horizon_10x", "breadth", "viscosity_ladder", "breadth_horizon_cross", "substrate_untethering", TRANSITION_ENERGY_CHARACTERIZATION, ASYMMETRY_LADDER, MAX_ENTROPY_PREFLIGHT, TOP_M_GEOMETRY_AUDIT, TOP_M_MECHANISM_AUDIT})
...
def active_spec_id(args: object) -> str:
    ...
    if str(getattr(args, "sweep_kind", "") or "") == TOP_M_MECHANISM_AUDIT:
        return TOP_M_MECHANISM_AUDIT_SPEC_ID
...
def artifact_prefix(kind: str) -> str:
    ...
    if kind == TOP_M_MECHANISM_AUDIT:
        return "top_m_mechanism_audit"
    if kind == "h128":
...
def run_phase(kind: str) -> str:
    ...
    if kind == TOP_M_MECHANISM_AUDIT:
        return "rfs_mb0_top_m_mechanism_audit"
    if kind == "h128":
...
def report_filename(kind: str) -> str:
    ...
    if kind == TOP_M_MECHANISM_AUDIT:
        return "rfs_mb0_top_m_mechanism_audit_result.md"
    if kind == "h128":
...
def default_horizon_pairs(*, use_h128: bool, sweep_kind: str = "") -> tuple[tuple[int, int], ...]:
    ...
    if sweep_kind in {"substrate_untethering", TRANSITION_ENERGY_CHARACTERIZATION, ASYMMETRY_LADDER, MAX_ENTROPY_PREFLIGHT, TOP_M_GEOMETRY_AUDIT, TOP_M_MECHANISM_AUDIT}:
