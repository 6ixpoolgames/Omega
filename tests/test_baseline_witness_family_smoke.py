...
def test_baseline_witness_family_smoke_checks_all_families() -> None:
    ...
    assert set(families) == {
        ...
        "same_control_reach_different_declared_recovery_family",
    ...
    assert families["same_control_reach_different_declared_recovery_family"]["case_count"] == 15
